...
* [Аннотации относящиеся к DI механизму](#аннотации-относящиеся-к-di-механизму)
  + [@Autowired](#autowired)
  + [@Bean](#bean)
  + [@Qualifier](#qualifier)
  + [@Required](#required)
...
* [Аннотации конфигурации](#аннотации-конфигурации)
  + [@Profile](#profile)
  + [@Import](#import)
...
## <a id="аннотации-относящиеся-к-di-механизму">Аннотации относящиеся к DI механизму</a>:

### <a id="autowired">@Autowired</a>
...
## <a id="аннотации-конфигурации">Аннотации конфигурации</a>
...
### <a id="import_resource">@ImportResource</a>
...
### <a id="property_source">@PropertySource</a>
...
### <a id="property_sources">@PropertySources</a>
